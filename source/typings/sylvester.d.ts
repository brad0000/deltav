...
interface Vector {
    ...
    /**
     * Returns the angle of the direction of the vector.
     */
    toAngle(): number;
    ...
    /**
     * Returns the result of dividing the elements of the vector by the argument.
     *
     * @param {number} k The value by which to divide the vector.
     */
